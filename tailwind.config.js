  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "benefit-1":"url('../../src/images/bg-benefit-1.png')",
        "benefit-2":"url('../../src/images/bg-benefit-2.png')",
        "cad":"url('../../src/images/cad.png')",
        "cam":"url('../../src/images/cam.png')",
        "auto":"url('../../src/images/auto.png')",
        "welding":"url('../../src/images/welding.png')",
        "uwelding":"url('../../src/images/uwelding.png')",
        "ogsci":"url('../../src/images/ogsci.png')",
