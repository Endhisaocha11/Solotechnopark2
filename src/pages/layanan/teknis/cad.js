...
import AvatarCAD from "@/images/layanan/teknis/avatar/avatarcad.png";
import BenefitCAD1 from "@/images/layanan/teknis/benefit/benefitcad1.png";
import BenefitCAD2 from "@/images/layanan/teknis/benefit/benefitcad2.png";
import BenefitCAD3 from "@/images/layanan/teknis/benefit/benefitcad3.png";
import BenefitCAD4 from "@/images/layanan/teknis/benefit/benefitcad4.png";
import BenefitCAD5 from "@/images/layanan/teknis/benefit/benefitcad5.png";
import BenefitCAD6 from "@/images/layanan/teknis/benefit/benefitcad6.png";
import BenefitCAD7 from "@/images/layanan/teknis/benefit/benefitcad7.png";
import ProspekCAD1 from "@/images/layanan/teknis/prospek/prospekcad1.png";
import ProspekCAD2 from "@/images/layanan/teknis/prospek/prospekcad2.png";
import ProspekCAD3 from "@/images/layanan/teknis/prospek/prospekcad3.png";
import ProspekCAD4 from "@/images/layanan/teknis/prospek/prospekcad4.png";
import GaleriCAD1 from "@/images/layanan/teknis/galeri/galericad1.png";
import GaleriCAD2 from "@/images/layanan/teknis/galeri/galericad2.png";
import GaleriCAD3 from "@/images/layanan/teknis/galeri/galericad3.png";
import GaleriCAD4 from "@/images/layanan/teknis/galeri/galericad4.png";
...
export default function LayananPendukung({ mitra, berita, testimoni }) {
  ...
  return (
    <>
      <NextSeo
        title="Desain Manufaktur - Solo Technopark"
          ...
          images: [
            {
              ...
              width: 800,
              height: 600,
              alt: "Desain Manufaktur Solo Technopark",
            },
          ],
          site_name: "Desain Manufaktur - solotechnopark",
        }}
      />

      <Head>
        <title>Desain Manufaktur - Solotechnopark.id</title>
      ...
      <main className="mt-20">
        <section className="bg-cad bg-cover bg-no-repeat">
          <div className="container">
            <div className="h-[90vh] flex flex-col justify-center">
              <h1 className="head-1 mb-5 max-w-3xl font-bold text-primary-100">
              {
                state.isLang === 'ID' ? ' Desain Manufaktur ' : ' Design Manufacture'
            }{" "}
              </h1>
              
              <h3 className="mb-5 max-w-3xl text-primary">
              {
                state.isLang === 'ID' ? ' Pelatihan keterampilan menggambar rancang bangun suatu produk yang memiliki presisi tinggi yang dikerjakan secara komputerisasi, dengan output SDM yang kompeten yang mudah terserap di dunia industri ' : ' Training in skills in drawing the design of a product that has high precision which is done computerized, with the output of competent human resources who are easily absorbed in the industrial world'
            }{" "}
              </h3>
                ...
                <div className="flex">
                    ...
                    <div className="flex-1 pl-5 py-10">
                        <div id="tentang" className="container py-20">
                            <h2 className="head-2 mb-5 font-bold text-primary-100">Tentang Desain Manufaktur</h2>
                            <div className="flex py-10 gap-10">
                                ...
                                <h4 className="mb-5 text-justify">
                                    Desain Manufaktur itu sendiri memiliki arti sebagai desain suatu produk atau komponen yang dapat memudahkan proses manufaktur, dengan tujuan menjadi satu kesatuan produk. Pelatihan Desain Manufaktur bertujuan agar produk yang akan dibuat memiliki akurasi dan tingkat presisi yang tinggi dengan biaya yang relatif rendah.
                                </h4>
                            </div>
                        </div>
                        ...
                        <div id="materi" className="container py-20">
                            ...
                            <div className="pb-10">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-1 gap-2 lg:gap-2">
                                    <div className="grid grid-cols-1 lg:grid-cols-1 gap-2 lg:gap-2">
                                        {dataMateriTeknis.cad &&
                                          dataMateriTeknis.cad.map((data, i) => (
                                            <div key={i} className="grid grid-cols-1 lg:grid-cols-2">
                                                <Card
                                                  key={i}
                                                  className={
        ...
        <section className="bg-grey">
          <div id="prospek" className="container py-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-2 lg:gap-2">
                {dataProspekTeknis.cad &&
                  dataProspekTeknis.cad.map((data, i) => (
                    <div key={i} className="grid grid-cols-1 lg:grid-cols-2">
                      {/* <Card
                        // key={i}
                        className={
        ...
        <section className="">
          <div id="galeri" className="container py-20">
            ...
            { state.isLang === 'ID' ? 'Galeri Desain Manufaktur' : 'Mechanical Manufacture Gallery'}
            </h2>
