...
import AvatarOtomasi from "@/images/layanan/teknis/avatar/avatarotomasi.png";
import BenefitOtomasi1 from "@/images/layanan/teknis/benefit/benefitotomasi1.png";
import BenefitOtomasi2 from "@/images/layanan/teknis/benefit/benefitotomasi2.png";
import BenefitOtomasi3 from "@/images/layanan/teknis/benefit/benefitotomasi3.png";
import BenefitOtomasi4 from "@/images/layanan/teknis/benefit/benefitotomasi4.png";
import BenefitOtomasi5 from "@/images/layanan/teknis/benefit/benefitotomasi5.png";
import BenefitOtomasi6 from "@/images/layanan/teknis/benefit/benefitotomasi6.png";
import BenefitOtomasi7 from "@/images/layanan/teknis/benefit/benefitotomasi7.png";
import ProspekOtomasi1 from "@/images/layanan/teknis/prospek/prospekotomasi1.png";
import ProspekOtomasi2 from "@/images/layanan/teknis/prospek/prospekotomasi2.png";
import ProspekOtomasi3 from "@/images/layanan/teknis/prospek/prospekotomasi3.png";
import GaleriOtomasi1 from "@/images/layanan/teknis/galeri/galeriotomasi1.png";
import GaleriOtomasi2 from "@/images/layanan/teknis/galeri/galeriotomasi2.png";
import GaleriOtomasi3 from "@/images/layanan/teknis/galeri/galeriotomasi3.png";
import GaleriOtomasi4 from "@/images/layanan/teknis/galeri/galeriotomasi4.png";
...
export default function LayananPendukung({ mitra, berita, testimoni }) {
  ...
  return (
    <>
      <NextSeo
        title="Otomasi Manufaktur - Solo Technopark"
          ...
          images: [
            {
              ...
              width: 800,
              height: 600,
              alt: "Otomasi Manufaktur Solo Technopark",
            },
          ],
          site_name: "Otomasi Manufaktur - solotechnopark",
        }}
      />

      <Head>
        <title>Otomasi Manufaktur - Solotechnopark.id</title>
      ...
      <main className="mt-20">
        <section className="bg-auto bg-cover bg-no-repeat">
          <div className="container">
            <div className="h-[90vh] flex flex-col justify-center">
              <h1 className="head-1 mb-5 max-w-3xl font-bold text-primary-100">
              {
                state.isLang === 'ID' ? ' Otomasi Manufaktur ' : ' Automation Manufacture'
            }{" "}
              </h1>
              
              <h3 className="mb-5 max-w-2xl text-primary">
              {
                ...
                <div className="flex">
                    ...
                    <div className="flex-1 pl-5 py-10">
                        <div id="tentang" className="container py-20">
                            <h2 className="head-2 mb-5 font-bold text-primary-100">Tentang Otomasi Manufaktur</h2>
                            <div className="flex py-10 gap-10">
                                ...
                                <h4 className="mb-5 text-justify">
                                    Otomasi Manufaktur itu sendiri memiliki arti sebagai desain suatu produk atau komponen yang dapat memudahkan proses manufaktur, dengan tujuan menjadi satu kesatuan produk. Pelatihan Otomasi Manufaktur bertujuan agar produk yang akan dibuat memiliki akurasi dan tingkat presisi yang tinggi dengan biaya yang relatif rendah.
                                </h4>
                            </div>
                        </div>
                        ...
                        <div id="materi" className="container py-20">
                            ...
                            <div className="pb-10">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-1 gap-2 lg:gap-2">
                                    <div className="grid grid-cols-1 lg:grid-cols-1 gap-2 lg:gap-2">
                                        {dataMateriTeknis.otomasi &&
                                          dataMateriTeknis.otomasi.map((data, i) => (
                                            <div key={i} className="grid grid-cols-1 lg:grid-cols-2">
                                                <Card
                                                  key={i}
                                                  className={
        ...
        <section className="bg-grey">
          <div id="prospek" className="container py-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-2 lg:gap-2">
                {dataProspekTeknis.otomasi &&
                  dataProspekTeknis.otomasi.map((data, i) => (
                    <div key={i} className="grid grid-cols-1 lg:grid-cols-2">
                      {/* <Card
                        // key={i}
                        className={
        ...
        <section className="">
          <div id="galeri" className="container py-20">
            ...
            { state.isLang === 'ID' ? 'Galeri Otomasi Manufaktur' : 'Mechanical Manufacture Gallery'}
            </h2>
