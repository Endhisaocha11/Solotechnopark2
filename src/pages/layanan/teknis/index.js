...
import IconCAM from "@/images/layanan/CAM.png";
import IconCAD from "@/images/layanan/CAD.png";
import IconWelding from "@/images/layanan/Welding.png";
import IconOtomasi from "@/images/layanan/Automation.png";
import IconOGSCI from "@/images/layanan/OGSCI.png";
...
export default function LayananPendukung({ mitra, berita, testimoni }) {
  ...
  return (
    <>
      ...
      <Head>
        <title>Teknis - Solotechnopark.id</title>
      ...
      <main className="mt-20">
                ...
                dataProgram.map((data, i) => (
                  ...
                  >
                    <div>
                      ...
                      <h3
                        className="text-2xl text-center font-bold text-primary-100 mt-5 lg:mt-0 mb-6"
                        // style={{ maxWidth: "14rem" }}
                      >
                        {data.title}
                      </h3>
                      <p className="text-gray-600 max-w-md text-justify mb-10">{data.content}</p>
                      {i === 0 && (
                          <Link
                            className="inline-block"
                            href={
                              "https://solotechnopark.id/layanan/teknis/cam"
                            }
                            target="_blank"
                          >
                            <button>
                      ...
                      {i === 1 && (
                          <Link
                            className="inline-block"
                            href={
                              "https://solotechnopark.id/layanan/teknis/cad"
                            }
                            target="_blank"
                          >
                            <button>
                      ...
                      {i === 2 && (
                          <Link
                            className="inline-block"
                            href={
                              "https://solotechnopark.id/layanan/teknis/welding"
                            }
                            target="_blank"
                          >
                            <button>
                      ...
                      {i === 3 && (
                          <Link
                            className="inline-block"
                            href={
                              "https://solotechnopark.id/layanan/teknis/otomasi"
                            }
                            target="_blank"
                          >
                            <button>
                      ...
                      {i === 4 && (
                          <Link
                            className="inline-block"
                            href={
                              "https://solotechnopark.id/layanan/teknis/uwelding"
                            }
                            target="_blank"
                          >
                            <button>
                      ...
                      {i === 5 && (
                          <Link
                            className="inline-block"
                            href={
                              "https://solotechnopark.id/layanan/teknis/ogsci"
                            }
                            target="_blank"
                          >
                            <button>
                ...
                <div key={i} className="grid grid-cols-1 lg:grid-cols-2">
                  ...
                  {i === 0 && (
                    <Card
                      // key={i}
                      className={
                        "bg-benefit-1 bg-cover bg-center bg-no-repeat p-8 gap-10 lg:mx-5 col-span-2"
                      }
                    >                    
                      <div>
                        <h3
                  ...
                  {i === 1 && (
                    <Card
                      // key={i}
                      className={
                        "bg-benefit-2 bg-cover bg-center bg-no-repeat p-8 gap-10 lg:mx-5 col-span-2"
                      }
                    >                    
                      <div>
                        <h3
        ...
        <section className="bg-gray-100">
          <div className="container py-20">
            <h2 className="head-2 my-2 text-center max-w-3xl mx-auto">
