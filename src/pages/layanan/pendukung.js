      ...
      <main className="mt-20">
        <section className="bg-flower-1">
          <div className="container">
            <div className="h-[90vh] flex flex-col justify-center">
              ...
              {
                state.isLang === 'ID' ? 'Layanan Pendukung di Kawasan Sains dan Teknologi Solo Technopark' : 'Support Services in the Solo Technopark Science and Technology Area'
              }
              </h1>
              <Link href={"/kontak"}>
        ...
        <section className="">
          <div className="container py-20">
            ...
            { state.isLang === 'ID' ? 'Layanan Pendukung Kami' : 'Our Support Services'}
            </h2>
