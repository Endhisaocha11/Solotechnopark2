      ...
      <main className="mt-20">
        ...
        <section className="">
          <div className="container pt-20">
            ...
            {
                state.isLang === 'ID' ? 'Apasih itu diklat Oil and Gas Skill Center of Indonesia?' : 'What is the Oil and Gas Skill Center of Indonesia training?'
              }
            </h2>

            <div className="text-center max-w-5xl mx-auto text-gray-600">
              <p className="mb-4">
              { state.isLang === 'ID' ? 'Oil and Gas Skill Center of Indonesia (OGSCI) adalah sebuah program pelatihan yang diselenggarakan oleh Satuan Kerja Khusus Pelaksana Kegiatan Usaha Hulu Minyak dan Gas Bumi (SKK Migas) bekerja sama dengan Solo Technopark. Program ini bertujuan untuk memberikan fasilitas lengkap sebagai sarana sosialisasi, komunikasi, edukasi, dan informasi terkait industri hulu migas di Indonesia.'
               : 'The Oil and Gas Skill Center of Indonesia (OGSCI) is a training program organized by the Special Task Force for Upstream Oil and Gas Business Activities (SKK Migas) in collaboration with Solo Technopark. This program aims to provide complete facilities as a means of socialization, communication, education, and information related to the upstream oil and gas industry in Indonesia.'}
              </p>
              <p>
              { state.isLang === 'ID' ? 'Melalui pelatihan-pelatihan yang diselenggarakan di OGSCI, peserta akan mempelajari berbagai keterampilan dan teknik terkait industri hulu migas seperti electrical, instrument, mechanical, process operator, dan health and safety environment.Selain itu, program pelatihan OGSCI juga menawarkan pelatihan dibidang konstruksi dan manajemen proyek.'
               : 'Through the trainings held at OGSCI, participants will learn various skills and techniques related to the upstream oil and gas industry such as electrical, instrument, mechanical, process operator, and health and safety environment. In addition, the OGSCI training program also offers training in construction and project management.'}
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="">
          <div className="container py-20">
            <h2 className="head-2 my-10 text-center max-w-3xl mx-auto">
            { state.isLang === 'ID' ? 'Apa yang kita dapat pada diklat Oil and Gas Skill Center Indonesia?{" "}' 
            : 'What can we learn from the Oil and Gas Skill Center training Indonesia?{" "}'}
            </h2>
        ...
        <section className="">
          <div className="container">
            <h2 className="head-2 my-10 text-center max-w-3xl mx-auto">
            { state.isLang === 'ID' ? 'Sertifikasi apa yang akan didapatkan di diklat ini?{" "}' 
            : 'What certification will be obtained in this training?{" "}'}
            </h2>

            <div className="text-center max-w-5xl mx-auto text-gray-600">
              <p className="mb-4">
              { state.isLang === 'ID' ? 'Sertifikat yang diberikan dalam setiap pelatihan dari kami merupakan sertifikat yang diakui secara Nasional yakni melalui Badan Nasional Sertifikasi Profesi (BNSP) dan Kementrian Tenaga Kerja Republik Indonesia (Kemenaker) maupun Internasional oleh Engineering Construction Industry Training Board (ECITB) dan Offshore Petroleum Industry Training Organization (OPITO).' 
            : 'The certificates given in every training from us are certificates that are recognized nationally, namely through the National Professional Certification Agency (BNSP) and the Ministry of Manpower of the Republic of Indonesia (Kemenaker) as well as internationally by the Engineering Construction Industry Training Board (ECITB) and the Offshore Petroleum Industry Training Organization ( OPITOS).'}
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-primary-gradient-100">
          <div className="container py-20">
            <Card className="bg-white mx-10 lg:mx-24 p-20 flex flex-col justify-center items-center">
              ...
              { state.isLang === 'ID' ? 'Berminat mengikuti training OGSCI ?' : 'Interested in attending OGSCI training?'}
              </h2>
              <p className="max-w-lg text-gray-600 mb-10 text-center">
              { state.isLang === 'ID' ? 'Klik tombol dibawah untuk mencari segala informasi yang terkait training oil and Gass Skill Center of Indonesia' 
              : 'Click the button below to find all information related to the Oil and Gas Skill Center of Indonesia training'}
              </p>
              <Link href={"/kontak"}>
                <Button className="bg-blue-600 text-white hover:opacity-50 hover:bg-primary-gradient-200">
