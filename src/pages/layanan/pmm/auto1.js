...
export default function LayananPendukung({ mitra, berita, testimoni }) {
  ...
  return (
    <>
      <NextSeo
        title="Automation Manufaktur (Basic)"
          ...
          images: [
            {
              ...
              width: 800,
              height: 600,
              alt: "Automation Manufaktur (Basic)",
            },
          ],
          site_name: "Automation Manufaktur (Basic)",
        }}
      />

      <Head>
        <title>Automation Manufaktur (Basic)</title>
        ...
        <section className="bg-cam bg-cover bg-no-repeat">
          <div className="container">
            <div className="h-[90vh] flex flex-col justify-center">
              ...
              {
                state.isLang === 'ID' ? ' Automaion Manufaktur (Basic) ' : ' Automation Manufacture (Basic)'
            }{" "}
              </h1>
