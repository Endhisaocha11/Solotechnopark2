  ...
  return (
    <>
      ...
      <Head>
        ...
        />
        <link href="src/stylespmm.css" rel="stylesheet">
      </Head>
      <Navbar />
                ...
                <div className="flex gap-10">
                    ...
                    <div className="flex-1 py-10">
                        <div id="benefit" className="container pt-24">
                            ...
                            <div className="pb-10">
                                <h4 className="mb-5 text-justify">
                                    Mengikuti Platform Merdeka Mengajar Solo Technopark memberikan manfaat seperti peningkatan pengetahuan, keterampilan praktis, dan kemampuan perancangan, baik bagi individu maupun organisasi. Ini juga membantu dalam pemahaman tentang kebijakan keselamatan dan lingkungan.
                                </h4>
                                <div className="grid grid-cols-1 lg:grid-cols-1 gap-2 lg:gap-2">
                                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-2 lg:gap-2">
                                        {dataBenefitPMM.pmm && 
                                          dataBenefitPMM.pmm.map((data, i) => (
                                            <div key={i} className="grid grid-cols-1 lg:grid-cols-2">
                                                <Card
                                                  key={i}
                                                  className={
                                                    "p-4 gap-2 lg:mx-2 col-span-2 bg-red-800"
                                                  }
                                                >   
                                                  <div>
                                                    {i === 0 && (
                                                        <PiToolboxFill className="text-primary-100 w-20 h-20 mx-auto"/>
                                                    )}
                                                    {i === 1 && (
                                                        <MdBook className="text-primary-100ip w-20 h-20 mx-auto"/>
                                                    )}
                                                    {i === 2 && (
                                                        <PiCertificateFill className="text-primary-100 w-20 h-20 mx-auto"/>
                                                    )}
                                                  </div>
                                                  <div>
                                                    <h3
                                                      className="text-xl font-bold text-primary-100 mt-5 lg:mt-5 mb-5 text-center"
                                                    >
                                                      {data.title}
                                                    </h3>
                                                  </div>
                                                  <div>
                                                    <h4
                                                      className="text-justify mb-5 mx-auto"
                                                    >
                                                      {data.desc}
                                                    </h4>
                                                  </div>
                        ...
                        <div id="basic" className="container pt-24">
                            ...
                            <div className="pb-10">
                                <h4 className="mb-5 text-justify"> 
                                    Berikut kelas basic yang dapat anda ikuti di Platform Merdeka Mengajar Solo Technopark:
                                </h4>
                                <div className="grid grid-cols-1 lg:grid-cols-1 gap-2 lg:gap-2">
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-2">
                                        {dataKelasPMM.basic &&
                                          dataKelasPMM.basic.map((data, i) => (
                                            <div key={i} className="grid grid-cols-1 lg:grid-cols-2">
                                                <Card
                                                    key={i}
                                                    className={
                                                      "p-4 gap-2 lg:mx-2 col-span-2 bg-grey"
                                                    }
                                                 >
                                                    <div>
                                                      <h3
                                                        className="text-2xl text-center font-bold text-primary-100 mt-5 lg:mt-2 mb-6"
                                                        // style={{ maxWidth: "14rem" }}
                                                      >
                                                        {data.title}
                                                      </h3>
                                                      <h4
                                                        className="text-center text-primary-100 mt-5 lg:mt-0 mb-6"
                                                        // style={{ maxWidth: "14rem" }}
                                                      >
                                                        {data.duration}
                                                      </h4>
                                                      ...
                                                      {i === 0 && (
                                                          <Link
                                                            ...
                                                            href={
                                                              "https://solotechnopark.id/layanan/pmm/mechanical"
                                                            }
                                                            target="_blank"
                                                          >
                                                            <button>
                                                      ...
                                                      {i === 1 && (
                                                          <Link
                                                            className="inline-block"
                                                            href={
                                                              "https://solotechnopark.id/layanan/pmm/design"
                                                            }
                                                            target="_blank"
                                                          >
                                                            <button>
                                                      ...
                                                      {i === 2 && (
                                                          <Link
                                                            className="inline-block"
                                                            href={
                                                              "https://solotechnopark.id/layanan/pmm/welding1"
                                                            }
                                                            target="_blank"
                                                          >
                                                            <button>
                                                      ...
                                                      {i === 3 && (
                                                          <Link
                                                            className="inline-block"
                                                            href={
                                                              "https://solotechnopark.id/layanan/pmm/auto1"
                                                            }
                                                            target="_blank"
                                                          >
                                                            <button>
                        ...
                        <div id="specialist" className="container py-24">
                            <h2 className="head-2 mb-5 font-bold text-primary-100">Kelas Specialist</h2>
                            <div className="pb-10">
                                <h4 className="mb-5 text-justify"> 
                                    Berikut kelas specialist yang dapat anda ikuti di Platform Merdeka Mengajar Solo Technopark:
                                </h4>
                                <div className="grid grid-cols-1 lg:grid-cols-1 gap-2 lg:gap-2">
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-2">
                                        {dataKelasPMM.specialist &&
                                          dataKelasPMM.specialist.map((data, i) => (
                                            <div key={i} className="grid grid-cols-1 lg:grid-cols-2">
                                                <Card
                                                    key={i}
                                                    className={
                                                      "p-4 gap-2 lg:-2 col-span-2 bg-grey"
                                                    }
                                                 >
                                                    <div>
                                                      <h3
