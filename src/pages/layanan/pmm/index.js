                  ...
                  <div className="flex-1 py-10">
                      ...
                      <div className="pb-10 pt-10">
                        <div className="flex flex-row space-x-10 text-justify">
                          <div className="bg-no-repeat bg-cover bg-origin-border bg-custom-1">
                            <div className="relative w-64 h-80 p-6 roundedcustom shadow-lg rounded-lg">
                        ...
                        <div className="flex flex-wrap -mx-2 text-justify">
                          <div className="w-full md:w-1/2 lg:w-1/4 px-2 mb-4 flex">
                            <div
                              ...
                              <div className="gradient-bg bg-auto bg-cover p-6 text-white rounded-t-xl">
                              ...
                              <div className="p-5 bg-white flex-grow">
                                ...
                                <button
                                  className="inline-block mt-4 text-white bg-red-500 px-4 py-2 rounded-full hover:bg-red-800">Baca
                                  Selengkapnya
                                </button>
                              </div>
                    ...
                    <div id="specialist" className="container pt-24">
                      ...
                      <div className="pb-10 pt-10">
                        <div className="flex flex-wrap -mx-2 text-justify">
                          <div className="w-full md:w-1/2 lg:w-1/4 px-2 mb-4 flex">
                            <div className="bg-gray-100 p-6 rounded-lg shadow-lg flex flex-col justify-between flex-grow">
